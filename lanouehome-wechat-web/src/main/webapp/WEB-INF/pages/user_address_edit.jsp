...
<div class="page" data-name="user-address-edit">
	<div class="navbar">
		<div class="navbar-inner sliding">
			...
			<div class="right">
				<a id="user_address_edit_save" class="link" href="#"><span class="ios-only"> 保存 </span> </a>
			</div>
		</div>
	</div>
	<div class="page-content">
		<input id="user_address_id" type="hidden" value="${userAddress.userAddressId}" /> <input
			id="user_address_district_id" value="${userAddress.districtId}"
			type="hidden" />
			...
			<ul>
				<li class="item-content item-input" style="padding-left: 0;">
					...
					<div class="item-inner">
						...
						<div class="item-input-wrap">
							<input id="user_address_name" placeholder="名字"
								type="text" value="${userAddress.name}" /> <span
								class="input-clear-button value-not-null"> </span>
						</div>
					</div>
				</li>
				<li class="item-content item-input" style="padding-left: 0;">
					...
					<div class="item-inner">
						...
						<div class="item-input-wrap">
							<label class="radio"><input class="user-address-sex"
								...
								class="user-address-sex" type="radio" name="sex" value="2"
				...
				<li class="item-content item-input" style="padding-left: 0;">
					...
					<div class="item-inner">
						...
						<div class="item-input-wrap">
							<input id="user_address_telephone" placeholder="11位手机号" type="text"
								value="${userAddress.telephone}" /> <span
								class="input-clear-button value-not-null"> </span>
						</div>
					</div>
				</li>
					...
					<div class="item-inner">
						...
						<div class="item-input-wrap">
							<input id="user_address_district_name" placeholder="地区信息"
								type="text" value="${userAddress.districtName}" /> <span
								class="input-clear-button value-not-null"> </span>
						</div>
					...
					<div class="item-inner">
						...
						<div class="item-input-wrap">
							<textarea id="user_address_address" class="value-not-null"
								placeholder="街道门牌号信息">${userAddress.address}</textarea>
					...
					<div class="item-inner">
						...
						<div class="item-after">
							<label class="toggle toggle-init color-blue"> <input
								id="default_user_address" type="checkbox"
