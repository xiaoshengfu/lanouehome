...
<body>
	<form class="form-horizontal" id="itemAddForm"
		...
		<div class="container">
			...
			<div class="row form-group">
				<label class="control-label col-lg-1 col-md-2" for="price">商品价格:</label>
				<div class="col-lg-3 col-md-4">
			...
			<div class="row form-group">
				<label class="control-label col-lg-1 col-md-2" for="stock">商品库存:</label>
				<div class="col-lg-3 col-md-4">
					<div class="input-group">
			...
			<div class="row form-group">
				<label class="control-label col-lg-1 col-md-2" for="pic_input">商品图片:</label>
				<div class="col-lg-8 col-md-10">
					<input id="pic_input" name="pictureFiles" type="file" multiple>
				</div>
			</div>
			<div class="row form-group">
				<label class="control-label col-lg-1 col-md-2" for="editor">商品描述:</label>
				<div class="col-lg-8 col-md-10">
					<div id="editor"></div>
				</div>
			</div>
			<div class="row form-group">
				...
				<div class="col-lg-8 col-md-10">
					<input id="add_item_desc" type="button" class="btn btn-primary"
						value="提交" /> <input id="reset_button" type="button"
...
<script type="text/javascript">
	...
	$("#add_item_desc").click(function() {
		var check = true;
		var inputs = $("#itemAddForm").find("input");
